...
//
// Solidity: function minters(address ) view returns(uint256 maxPledgeCount, uint256 lastPledgeTime, uint256 times, uint256 invalidTimes, uint256 tblength, uint256 jclength, uint256 ztlength, uint256 totalBalance, uint256 totalRevenue, uint256 PDRevenue, uint256 ZTRevenue, uint256 JCRevenue)
func (_DABC *DABCCaller) Minters(opts *bind.CallOpts, arg0 common.Address) (struct {
	...
	outstruct.Jclength = *abi.ConvertType(out[5], new(*big.Int)).(**big.Int)
	outstruct.Ztlength = *abi.ConvertType(out[6], new(*big.Int)).(**big.Int)
	outstruct.TotalBalance = *abi.ConvertType(out[7], new(*big.Int)).(**big.Int)
	outstruct.TotalRevenue = *abi.ConvertType(out[8], new(*big.Int)).(**big.Int)
	outstruct.PDRevenue = *abi.ConvertType(out[9], new(*big.Int)).(**big.Int)
	outstruct.ZTRevenue = *abi.ConvertType(out[10], new(*big.Int)).(**big.Int)
	outstruct.JCRevenue = *abi.ConvertType(out[11], new(*big.Int)).(**big.Int)
